       ...
       {/* --- NOVO: PAINEL DE MÉDIA DE GOLS ADICIONADO AQUI --- */}
         ...
         <div className="text-sm font-medium text-center text-gray-500 border-b border-gray-200">
             <ul className="flex flex-wrap -mb-px">
                 ...
                 <li className="mr-2"><button onClick={() => setActiveTab('h2h')} className={`inline-block p-2 border-b-2 rounded-t-lg ${activeTab === 'h2h' ? 'text-blue-600 border-blue-600' : 'border-transparent hover:text-gray-600'}`}>H2H</button></li>
                 <li className="mr-2"><button onClick={() => setActiveTab('form')} className={`inline-block p-2 border-b-2 rounded-t-lg ${activeTab === 'form' ? 'text-blue-600 border-blue-600' : 'border-transparent hover:text-gray-600'}`}>Forma</button></li>
...
export default function JogosCliente({ initialData }: { initialData: any }) {
  ...
  const ALLOWED_LEAGUE_IDS = [
    2, 3, 4, 13, 11, 31, 39, 40, 41, 42, 43, 45, 47, 48, 98, 101, 102, 103, 106, 107, 108, 109, 119, 120, 124, 125, 128, 129, 130, 131, 140, 141, 173, 175, 176, 177, 178, 179, 182, 181, 184, 185, 135, 136, 219, 220, 242, 243, 244, 245, 246, 247, 248, 249, 250, 251, 262, 264, 271, 272, 282, 283, 281, 284, 285, 328, 329, 345, 347, 78, 473, 474, 501, 503, 527, 558, 559, 633, 638, 497, 519, 555, 557, 592, 593, 548, 657, 722, 727, 807, 810, 4330, 4395, 4888, 4400, 21, 79, 61, 62, 94, 88, 71, 72, 144, 147, 253, 113, 207, 208, 307, 203, 218, 15, 1
  ];
