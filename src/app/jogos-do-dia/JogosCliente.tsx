...
export default function JogosCliente({ initialData }: { initialData: any }) {
  ...
  const ALLOWED_LEAGUE_IDS = [
    2, 3, 4, 13, 11, 31, 39, 40, 41, 42, 43, 45, 47, 48, 98, 101, 102, 119, 120, 124, 125, 140, 141, 179, 182, 181, 184, 185, 135, 136, 242, 243, 262, 282, 283, 281, 78, 503, 558, 638, 497, 555, 592, 593, 548, 807, 4330, 4395, 4888, 4400, 21, 79, 61, 62, 94, 88, 71, 72, 144, 253, 113, 207, 307, 203, 218, 15, 1
  ];
